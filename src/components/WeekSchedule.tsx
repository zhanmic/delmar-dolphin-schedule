      ...
      <div className="week-list week-list--fit" role="list">
        {dayGroups.map((group) => (
          <section
            ...
            role="listitem"
            aria-label={`${group.heading.weekday} ${group.heading.shortDate}`}
            style={
              {
          ...
          >
            <header className="day-group__when">
              <span className="day-group__weekday">{group.heading.weekday}</span>
              <span className="day-group__date">{group.heading.shortDate}</span>
            </header>
